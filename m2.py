...
lb_question.setStyleSheet('color:#FF2F15; font-size:20px')
window.setStyleSheet('background: white')
lb_rest = QLabel("хвилин")
lb_result = QLabel("Правильно")
lb_right_answwer = QLabel("отвєт")

sp_rest = QSpinBox()
gb_question = QGroupBox("Варіанти отвєта")
